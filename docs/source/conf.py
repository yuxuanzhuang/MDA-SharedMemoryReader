...
import sharedmemoryreader  # noqa



# -- Project information -----------------------------------------------------

project = "SharedMemoryReader"
copyright = (
    "2024, Yuxuan Zhuang. "
...
htmlhelp_basename = "sharedmemoryreaderdoc"
...
latex_documents = [
    (master_doc, "sharedmemoryreader.tex", "SharedMemoryReader Documentation",
     "sharedmemoryreader", "manual"),
]
...
man_pages = [
    (master_doc, "sharedmemoryreader", "SharedMemoryReader Documentation",
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, "sharedmemoryreader", "SharedMemoryReader Documentation",
     author, "sharedmemoryreader", "SharedMemoryReader for MDAnalysis",
     "Miscellaneous"),
]
